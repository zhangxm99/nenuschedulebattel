...
headers={
    ...
    'Referer': 'http://'+str(server)+'/qzxk/xk/getXkInfo?jx0502zbid=108&jx0502id=47&sfktx=1&sfkxk=1'
}
...
def main(account,password):
    ...
    print(res)
    url_show = "http://"+str(server)+"/qzxk/xk/getXkInfo?jx0502zbid=108&jx0502id=47&sfktx=1&sfkxk=1"
